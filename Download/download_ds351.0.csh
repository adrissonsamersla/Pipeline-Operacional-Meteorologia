#!/bin/csh
#################################################################
# Csh Script to retrieve 1 online Data file of 'ds351.0',
# total 14.54M. This script uses 'wget' to download data.
#
...
set opt2 = "email=sadrianorod@gmail.com&passwd=$pswd&action=login"
