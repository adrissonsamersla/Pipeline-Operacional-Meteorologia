...
class MessageParser:
    ...
    ##############################################################
    def __set_obs(self, value: float, qc: int, idx: int):
        # Default value
        content = "-888888.00000      0"
        ...
        self.observations[idx] = content

    def set_obs_pressure(self, pressure: float = None, qc: int = None):
        if (pressure is None):
            self.__set_obs(pressure, qc, 0)
        else:
            #Unit conversion: Hpa => Pa
            converted = pressure * 100
            self.__set_obs(converted, qc, 0)

    def set_obs_height(self, height: float = None, qc:int = None):
        self.__set_obs(height, qc, 1)

    def set_obs_temperature(self, temperature: float = None, qc: int = None):
        if (temperature is None):
            self.__set_obs(temperature, qc, 2)
        else:
            # Unit conversion: oC => K
            converted = temperature + 273.15
            self.__set_obs(converted, qc, 2)

    def set_obs_dew_point(self, dew_point: float = None, qc = None):
        if (dew_point is None):
            self.__set_obs(dew_point, qc, 3)
        else:
            # Unit conversion: oC => K
            converted = dew_point + 273.15
            self.__set_obs(converted, qc, 3)

    def set_obs_wind_speed(self, wind_speed = None, qc = None):
        self.__set_obs(wind_speed, qc, 4)

    def set_obs_wind_direction(self, wind_direction = None, qc = None):
        self.__set_obs(wind_direction, qc, 5)

    def set_obs_wind_ew(self, wind_ew = None, qc = None):
        self.__set_obs(wind_ew, qc, 6)

    def set_obs_wind_ns(self, wind_ns = None, qc = None):
        self.__set_obs(wind_ns, qc, 7)

    def set_obs_relative_humidity(self, relative_humidity = None, qc = None):
        self.__set_obs(relative_humidity, qc, 8)

    def set_obs_thickness(self, thickness = None, qc = None):
        self.__set_obs(thickness, qc, 9)
    ...
    def full_message(self) -> str:
        ...
        obs_line = "".join(self.observations)
